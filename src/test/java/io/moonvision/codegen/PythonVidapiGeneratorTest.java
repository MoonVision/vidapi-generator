 ...
 * 1) Set a break point in PythonAsyncioCodegen.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class PythonVidapiGeneratorTest {
    ...
    public void launchCodeGenerator() {
        ...
        final CodegenConfigurator configurator = new CodegenConfigurator()
                .setGeneratorName("io.moonvision.codegen.PythonVidapiGenerator") // use this codegen library
                ...
                .setOutputDir("out/openapi"); // output directory
