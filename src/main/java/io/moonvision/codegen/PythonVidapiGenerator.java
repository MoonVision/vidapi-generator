 ...
 * Copyright 2020 The Moonvision GmbH
 *
...
public class PythonVidapiGenerator extends DefaultCodegen implements CodegenConfig {
    private static final Logger LOGGER = LoggerFactory.getLogger(PythonVidapiGenerator.class);

    public static final String PACKAGE_URL = "packageUrl";
    public static final String DEFAULT_LIBRARY = "asyncio";
    ...
    public PythonVidapiGenerator() {
        ...
        embeddedTemplateDir = templateDir = "python-vidapi";
    ...
    private String toExampleValueRecursive(Schema schema, List<String> included_schemas, int indentation) {
        ...
        if (ModelUtils.isDateSchema(schema)) {
            ...
            System.out.println("ModelUtils.isObjectSchema");
            System.out.println(toModelName(schema.getTitle()));
            ...
            if ("object".equals(schema.getType())) {
                ...
                example = packageName + ".models." + toModelName(schema.getTitle()) + "(";
            }
